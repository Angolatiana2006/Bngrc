    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="alert alert-info">
                ...
                Vous pouvez soit sélectionner un type de don existant, soit créer un nouveau type.
                <br><strong>Important :</strong> Pour les nouveaux types, le prix unitaire est obligatoire.
            </div>
            ...
            <form method="POST" action="/dons/create" class="mt-4">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="type_categorie">Catégorie</label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="nom_besoin">Nom du don</label>
                        <input type="text" class="form-control" id="nom_besoin" name="nom_besoin" 
                               placeholder="Ex: riz, sucre, ciment" 
                               value="<?= htmlspecialchars($old['nom_besoin'] ?? '') ?>">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="prix_unitaire">Prix unitaire (AR)</label>
                        <input type="number" step="0.01" min="0.01" class="form-control" id="prix_unitaire" name="prix_unitaire" 
                               value="<?= htmlspecialchars($old['prix_unitaire'] ?? '') ?>"
                               placeholder="Ex: 2000">
                    </div>
                </div>
                <small class="form-text text-muted">Remplissez ces trois champs seulement si c'est un nouveau type</small>
